...
- **Public cadence**: one write-up per finished project; cross-post summary into vault wiki page (like [[builds/retrieval-agent/overview]]).
...
[[roadmap-software-engineer]] Stage 4 · [[roadmap-ml-engineer]] Stages 3–4 · [[how-to-self-teach]] · [[interview-counter-guide]] · [[builds/stock-agent/overview]] · [[builds/retrieval-agent/overview]]