...
4. **Verify**:
   ...
   - Agent answers with citations like `wiki/modules/business/refund-policy.md`
...
- [[wiki/modules/automations/patterns/webhook-response-pattern|Webhook Response Pattern]] — n8n webhook best practices
- [[wiki/modules/programming/SAAS_BUILD_NOTES|SaaS Build Notes]] — Supabase Edge Function patterns