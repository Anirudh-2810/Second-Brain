...
## For future agent
**DOMAIN SCOPE**: Questions about the user's OWN built systems (stock-agent architecture/bugs/roadmap, the retrieval-agent business brain, GitHub portfolio repos) → scan `wiki/builds/**`. These are LIVING documents — update them as the builds evolve.
...
How to BUILD projects generally → [[build-project-playbook]] (business) · Reference architectures studied → `wiki/programming/case-studies/`

## Cross-Domain Bridges

stock-agent ML internals ↔ ai-data · quant strategies ↔ business/quant-finance · interview stories ↔ [[interview-counter-guide]] · Roadmaps hub: [[roadmaps/INDEX]]
