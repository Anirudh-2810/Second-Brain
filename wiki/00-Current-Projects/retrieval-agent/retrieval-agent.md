...
- **Format**: At end of answer, list: `Sources: wiki/01-Areas/<Domain>/path/to/note.md`
...
- [[wiki/01-Areas/Business/automations/patterns/webhook-response-pattern|Webhook Response Pattern]] — Error handling patterns