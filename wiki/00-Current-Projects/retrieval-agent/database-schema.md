...
CREATE TABLE brain_chunks (
  ...
  path TEXT NOT NULL,                    -- e.g., "wiki/01-Areas/Business/quant-finance/momentum-jegadeesh-titman.md"
...
UPDATE brain_chunks SET status = 'archived' WHERE path LIKE 'wiki/98-Archive/%';
...
- [[wiki/01-Areas/Programming/SAAS_BUILD_NOTES|SaaS Build Notes]] — Supabase patterns (RLS, RPC, migrations)