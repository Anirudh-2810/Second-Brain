...
- **Phase 3 — Daily working increments.** Winner's loop / never-zero-days from [[self-dev/self-mastery/life-systems-design|Life Systems Design]]: every day ends with a *running* app. Commit to git at every green point.
