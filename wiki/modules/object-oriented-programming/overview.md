...
- OOP is the backbone of the quant modules' Python: [[quant-finance/quant-toolkit-and-skills]], [[ai-ml/event-driven-backtesting]] (event objects, backtest engine classes).
...
- Back to the catalog: [[modules/index]] · [[modules/programming/overview|Programming module]]
