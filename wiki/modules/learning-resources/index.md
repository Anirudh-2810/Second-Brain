...
unit: "Module Index"
tags: [learning-resources, catalogs, index, free-resources]
last_updated: "2026-08-24"
description: "Hub for the great learning-resource catalogs (awesome, freeCodeCamp, OSSU CS, build-your-own-x etc.) with anti-hoarding usage protocols"
---
...
```mermaid
flowchart LR
    C["Catalog opened"] --> Q{"Current project/<br/>stage question?"}
    Q -->|"yes"| P["Pick ONE item,<br/>use it NOW"]
    Q -->|"no"| B["Bookmark max,<br/>close tab.<br/>Browsing ≠ progress"]
    P --> L["Log artifact in vault"]
```
...
[[modules/careers/index|Careers Hub]] · [[modules/data-science/index|Data Science Hub]] · [[modules/programming/overview|Programming Hub]] · [[roadmaps-and-study-guides]]