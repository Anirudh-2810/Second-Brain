...
> **Related:** [[modules/robotics/index|Robotics & ROS2 Hub]] · [[robotics-fundamentals]] · [[modules/index|Modules Catalog]] · [[wiki/index|Wiki Home]]
...
|---|---|---|
| AI/ML | perception (CNN), RL control (PPO), planning | [[modules/ai/index|AI Hub]] |
| Mathematics | transforms (LinAlg), Bayes (prob), dynamics (ODE) | [[modules/mathematics/overview|Mathematics]] |
| Programming/CS50 | every node is a program; data structures for grids/trees | [[modules/programming/cs50/index|CS50]] |
| OOP | node/interface/package architecture | [[modules/object-oriented-programming/overview|OOP]] |
| C++ systems | real-time loops, deterministic memory | [[modules/ai-ml/matching-engine-cpp|Matching Engine]] |
| Self-Mastery | running multi-week engineering builds | [[modules/self-mastery/overview|Self-Mastery]] |
| Quant/backtesting | *same* discipline: data → model → decision loop, look-ahead bugs | [[modules/ai-ml/event-driven-backtesting|Backtesting]] |
