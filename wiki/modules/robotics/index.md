...
- **[[modules/programming/index|Programming Module Hub]]** — Python & CS fundamentals, the language ROS2 nodes are written in.
- **[[modules/ai/index|AI / Machine Learning]]** — perception & decision layers of robots (vision, RL control).
- **[[modules/mathematics/overview|Mathematics]]** — linear algebra, trigonometry & probability behind kinematics, Kalman filters & SLAM.
- **[[modules/ai-ml/reinforcement-learning-ppo|Reinforcement Learning — PPO]]** — learned control policies on top of the ROS2 stack.
- **[[modules/ai-ml/matching-engine-cpp|Matching Engine (C++)]]** — low-latency C++ systems thinking, same discipline as robot controllers.
- **[[modules/self-mastery/overview|Self-Mastery]]** — the learning engine: how to actually run a multi-week robotics curriculum to completion.
