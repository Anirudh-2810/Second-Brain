...
- [SoftwareArchitect roadmap](https://github.com/justinamiller/SoftwareArchitect) · [GoF origins](https://en.wikipedia.org/wiki/Design_Patterns) → implementations [[modules/object-oriented-programming/design-patterns]]
...
[[dsa-interview-playbook]] · [[repo-teachyourselfcs]] · [[languages-python-advanced]] · [[language-rust]] · [[how-to-self-teach]] · [[modules/programming/cs50/index]]