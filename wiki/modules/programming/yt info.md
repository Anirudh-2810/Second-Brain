...
> **Full knowledge-base pages:** `[[modules/index#programming--computer-science]]` in `/wiki/`.
> **Compiled:** 2026-08-11
...
- [ ] Read each wiki node under `[[modules/index#programming--computer-science]]` for full depth (+ Mermaid flowcharts).
- [ ] **Start the concrete curriculum:** [[modules/programming/cs50/index|Harvard CS50x full course notes]] — the 11-week practiced backbone recommended by Video 5 (one long-form resource → execute its PSets).
