...
Comprehensions, unpacking, `*args/**kwargs`, exceptions done right, classes → [[modules/object-oriented-programming/oop-foundations]], f-strings, `pathlib`.
...
Context managers, generators/laziness, decorators, dunder survey → [[modules/object-oriented-programming/magic-methods-dunder]], typing hints, async reality-check (benchmarks show asyncio often loses to threads for HTTP servers — [[languages-python-advanced]]).
...
[[modules/programming/cs50/week-6-python]] · [[modules/object-oriented-programming/overview]] · [[languages-python-advanced]] · [[how-to-self-teach]] · [[roadmap-data-scientist]]