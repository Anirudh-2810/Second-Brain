...
- ROS bridge: [ros_people_object_detection_tensorflow](https://github.com/cagbal/ros_people_object_detection_tensorflow) → [[modules/robotics/index]]
...
- Vault: [[modules/quant-finance/forecasting-and-market-efficiency]]
...
- [AirSim (Microsoft)](https://github.com/microsoft/AirSim) — autonomous-vehicle simulator → [[modules/robotics/index]]
- [RLTrader](https://github.com/notadamking/RLTrader) — crypto trading gym → [[modules/quant-finance/applications-of-quantitative-finance]]
...
[[python-datascience-frameworks]] · [[roadmap-data-scientist]] · [[roadmap-ml-engineer]] · [[modules/ai/AI_MASTER_NOTES]] · [[curated-reading-list]]