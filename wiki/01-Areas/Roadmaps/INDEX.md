---
course_code: "ROADMAPS"
course_name: "Roadmaps Hub (Cross-Domain)"
unit: "Master Roadmap Index"
tags: [roadmaps, index, hub, learning-paths]
last_updated: "2026-08-24"
confidence: high
description: "ROADMAPS hub - every roadmap and study-plan page across all domains, linked in one place with a suggested combined sequence"
---
...
```mermaid
flowchart TD
    NOW["NOW (yr-2 sem):<br/>SWE roadmap Stage 1-2<br/>+ CS50 continuation"] --> I["Yr-2 break:<br/>Python mastery M3-M4<br/>+ first deployed project"]
    I --> Y3["Yr-3:<br/>MLE track Stage 2-3<br/>+ internship hunt"]
    Y3 --> Y4["Yr-4:<br/>interview grind<br/>+ builds/ portfolio polish"]
    Y4 --> J["Offers"]
```
