...
> **Related:** [[engineering/robotics/index|Robotics & ROS2 Hub]] · [[robotics-fundamentals]] · [[modules/index|Modules Catalog]] · [[wiki/index|Wiki Home]]
...
|---|---|---|
| AI/ML | perception (CNN), RL control (PPO), planning | [[ai-data/ai/index|AI Hub]] |
| Mathematics | transforms (LinAlg), Bayes (prob), dynamics (ODE) | [[engineering/mathematics/overview|Mathematics]] |
...
| C++ systems | real-time loops, deterministic memory | [[ai-data/ai-ml/matching-engine-cpp|Matching Engine]] |
| Self-Mastery | running multi-week engineering builds | [[self-dev/self-mastery/overview|Self-Mastery]] |
| Quant/backtesting | *same* discipline: data → model → decision loop, look-ahead bugs | [[ai-data/ai-ml/event-driven-backtesting|Backtesting]] |
