...
- **[[ai-data/ai/index|AI / Machine Learning]]** — perception & decision layers of robots (vision, RL control).
- **[[engineering/mathematics/overview|Mathematics]]** — linear algebra, trigonometry & probability behind kinematics, Kalman filters & SLAM.
- **[[ai-data/ai-ml/reinforcement-learning-ppo|Reinforcement Learning — PPO]]** — learned control policies on top of the ROS2 stack.
- **[[ai-data/ai-ml/matching-engine-cpp|Matching Engine (C++)]]** — low-latency C++ systems thinking, same discipline as robot controllers.
- **[[self-dev/self-mastery/overview|Self-Mastery]]** — the learning engine: how to actually run a multi-week robotics curriculum to completion.
