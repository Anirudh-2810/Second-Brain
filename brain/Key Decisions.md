...
- **2026-08-27 — Agent tooling lives in vault-native locations, not a new wiki folder.** The user rejected a new `wiki/01-Areas/AI-Data/agentic-ai/` module in favor of distributing content where it already grows: reusable template in `templates/agent-definition.md`, durable principles in `brain/Agentic AI Playbook.md`, roster digest in `thinking/2026-08-27-agency-agents.md`, browseable view in `bases/Agents.base`. Agent definitions are tooling, not study content — putting them on wiki pages would duplicate the `.opencode/agents/` source of truth. Source: `[[Agentic AI Playbook]]`
