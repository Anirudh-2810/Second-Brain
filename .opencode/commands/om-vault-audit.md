...
Check:
1. **Indexes**: does `wiki/index.md` + domain INDEXes match actual `wiki/01-Areas/` pages? Does `wiki/log.md` have entries for recent additions? Is `daily/index.md` current? Is every `brain/` topic note listed in `brain/Memories.md`?
